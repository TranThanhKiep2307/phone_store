...
class product
{
    ...
    public function insert_product($data, $files)
    {
        ...
        if (
            $SP_TEN == "" || $danhmuc == "" || $loai_sp == "" || $SP_MOTA == "" || $SP_GIA == "" || $SP_MAU == ""
    ...
    public function search($timkiem,  $category)
    {
        $sql = "SELECT * FROM sanpham WHERE SP_TEN LIKE '%$timkiem%'";

        if ($category != 0) {
            $sql .= " AND SP_MA = $category";
        }
