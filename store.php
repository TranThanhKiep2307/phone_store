							...
							<div class="col-md-4 col-xs-6">
								...
								<div class="product">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#"><?php echo $result_new['SP_TEN']?></a></h3>
										<h4 class="product-price">$980.00 <del class="product-old-price"><?php echo $result_new['SP_GIA']." "."VNĐ"?></del></h4>
