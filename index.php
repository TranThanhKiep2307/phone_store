						...
						<div class="section-title">
							...
							<div class="section-nav">
								...
								<li class="active"><a data-toggle="tab" href="#tab2">Điện thoại</a></li>
									...
									<li><a data-toggle="tab" href="#tab2">Dây sạc</a></li>
								</ul>
							</div>
						</div>
					</div>
										...
										<div class="product">
											...
											<p class="product-category"><?php echo $result['DMSP_MA']?></p>
												...
												<div class="product-btns">
													...
													<button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp"><?php echo $fm->textShorten($result['SP_MOTA'], 200) ?></span></button>
												</div>
											</div>
